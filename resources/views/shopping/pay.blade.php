                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-3 col-xs-3">
                                        <img class="img-responsive" src="{{pare_url_file($product->attributes->avatar)}}" />
                                    </div>
                                    <div class="col-sm-6 col-xs-6">
                                        <div class="col-xs-12">{{$product->name}}</div>
                                        <div class="col-xs-12"><small>Số lượng x <span>{{$product->quantity}}</span></small></div>
                                    </div>
                                    <div class="col-sm-3 col-xs-3 text-right">
                                        <h6>{{number_format($product->price * $product->quantity,0,',','.')}} <span>VNĐ</span></h6>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="pull-right"><span>{{number_format(\Cart::getSubTotal(),0,',','.')}}</span> <span>VNĐ</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
