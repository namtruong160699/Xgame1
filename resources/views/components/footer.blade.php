                ...
                <div class="col-md-3 col-sm-4">
                    <div class="info-fcontainer">
                        ...
                        <div class="infof-content">
                            <h3>Địa chỉ</h3>
                            <p>thôn Đồn Thượng, xã Đức Liên, huyện Vũ Quang, tỉnh Hà Tĩnh</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    <address>Copyright © <a href="http://bootexperts.com/">NAMTRUONG.</a> All Rights Reserved</address>
                </div>
                <div class="col-md-6 col-xs-12">
