                                    ...
                                    <div class="single-product">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img class="primary-image"
                                                         src="{{asset('img/products/product-7.jpg')}}" alt=""/>
                                                    <img class="secondary-image"
                                                         src="{{asset('img/products/product-2.jpg')}}" alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="product-content">
                                                ...
                                                <div class="product-desc">
                                                    <p>Nunc facilisis sagittis ullamcorper. Proin lectus ipsum, gravida
                                                        ...
                                                        posuere cubilia Curae; Aenean eleifend laoreet congue. Viva</p>
                                                </div>
                                                <div class="actions-e">
                                                    <div class="action-buttons">
                                                        <div class="add-to-cart">
                                            ...
                                            <div class="product-img">
                                                <a href="#">
                                                    <img class="primary-image"
                                                         src="{{asset('img/products/product-7.jpg')}}" alt=""/>
                                                    <img class="secondary-image"
                                                         src="{{asset('img/products/product-8.jpg')}}" alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="single-product">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img class="primary-image"
                                                         src="{{asset('img/products/product-5.jpg')}}" alt=""/>
                                                    <img class="secondary-image"
                                                         src="{{asset('img/products/product-6.jpg')}}" alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="single-product">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img class="primary-image"
                                                         src="{{asset('img/products/product-11.jpg')}}" alt=""/>
                                                    <img class="secondary-image"
                                                         src="{{asset('img/products/product-12.jpg')}}" alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="single-product">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img class="primary-image"
                                                         src="{{asset('img/products/product-9.jpg')}}" alt=""/>
                                                    <img class="secondary-image"
                                                         src="{{asset('img/products/product-10.jpg')}}" alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="single-product">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img class="primary-image"
                                                         src="{{asset('img/products/product-4.jpg')}}" alt=""/>
                                                    <img class="secondary-image"
                                                         src="{{asset('img/products/product-5.jpg')}}" alt=""/>
                                                </a>
                                            </div>
                                            ...
                                            <div class="product-img">
                                                <a href="#">
                                                    <img class="primary-image"
                                                         src="{{asset('img/products/product-2.jpg')}}" alt=""/>
                                                    <img class="secondary-image"
                                                         src="{{asset('img/products/product-3.jpg')}}" alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="single-product">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img class="primary-image"
                                                         src="{{asset('img/products/product-1.jpg')}}" alt=""/>
                                                    <img class="secondary-image"
                                                         src="{{asset('img/products/product-1.jpg')}}" alt=""/>
                                                </a>
                                            </div>
