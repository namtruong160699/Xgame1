...
@section('content')
    ...
    <div class="table-responsive">
        <h2>Quản lý đơn hàng <a href="" class="pull-right"><i class="fas fa-plus-circle"></i></a></h2>
            ...
            @foreach($transactions as $transaction)
                <tr>
                    ...
                    <td>
                        ...
                        <a class="js_order_item" href="{{route('admin.get.view.order',$transaction->id)}}" data-id="{{$transaction->id}}"><i class="fas fa-eye"></i></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
